...
#define JADARD_common_NAME "jdcommon"
#define JADARD_BUS_RETRY_TIMES 20
...
//zsw int jadard_fb_notifier_callback(struct notifier_block *self, unsigned long event, void *data);
#endif
