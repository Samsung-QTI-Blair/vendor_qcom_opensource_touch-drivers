...
//-P86801AA1 peiyuexiang.wt 20230703, add, hardware_info
	if (strstr(panel_name_tp,"lide_hx83102j_wt_dsi_vdo_90hz_hsd")) {
		snprintf(hardinfo,HARDWARE_MAX_ITEM_LONGTH,"IC:hx83102j, Module:lide, FW:0x%04x",
			hx_s_ic_data->vendor_touch_cfg_ver);
	} else if (strstr(panel_name_tp,"starry_hx83102j_wt_dsi_vdo_90hz_mdt_agc")) {
		snprintf(hardinfo,HARDWARE_MAX_ITEM_LONGTH,"IC:hx83102j, Module:starry_agc, FW:0x%04x",
			hx_s_ic_data->vendor_touch_cfg_ver);
	} else if (strstr(panel_name_tp,"starry_hx83102j_wt_dsi_vdo_90hz_mdt")) {
		snprintf(hardinfo,HARDWARE_MAX_ITEM_LONGTH,"IC:hx83102j, Module:starry, FW:0x%04x",
			hx_s_ic_data->vendor_touch_cfg_ver);
	}
	hardwareinfo_set_prop(HARDWARE_TP, hardinfo);
	I("firmware_ver=%s", hardinfo);
//-P86801AA1 peiyuexiang.wt 20230703, add, hardware_info
}
