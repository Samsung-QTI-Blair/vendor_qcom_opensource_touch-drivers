...
static int fts_test_save_test_data(char *file_name, char *data_buf, int len)
{
    ...
    if (NULL == pfile) {
//+P86801AA1 peiyuexiang.wt,add,20230427,Focaltech_ft8203 openshort
...
int fts_ft8203_open_short_test(char *ini_file_name)
{
    int ret = 0;
    int result = 0;
    ...
    if (ret < 0) {
       ...
       result = fts_test_entry(ini_file_name);
    }
...
EXPORT_SYMBOL(fts_ft8203_open_short_test);
//-P86801AA1 peiyuexiang.wt,add,20230425,Focaltech_ft8203 openshort
