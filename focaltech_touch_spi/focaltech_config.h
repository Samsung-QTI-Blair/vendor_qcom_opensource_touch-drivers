 ...
 * Report plam event in multitouch
 * 1:enable(default),0:disable
*/
#define FTS_SAMSUNG_SCREEN_SHOT_EN              1
/*TabA7 Lite code for OT8-3425 by liupengtao at 20210222 end*/
/*
 * Stylus PEN enable
 * 1:enable(default),0:disable
*/
#define FTS_PEN_EN                              0//1
 ...
 * default: disable
 */
#define FTS_ESDCHECK_EN                         1//0

/*
 * Pinctrl enable
 * default: disable
 */
#define FTS_PINCTRL_EN                          1//0
 ...
 * auto upgrade
 */
#define FTS_AUTO_UPGRADE_EN                     1//0
